...
public final class TransitionDenied extends IllegalStateException {
	...
	public static enum Error {
		...
		E5_SITE_LIMIT_REACHED(5, "Sites per user/area are limited to %d."), 
		E6_SITE_OWNERSHIP_REQUIRED(6, "Only the owner or maintainer of site %s may change it."), 
		E7_SITE_EXISTS(7, "Site %s already exists."), 
		E8_PRODUCT_OWNERSHIP_REQUIRED(8, "To extend product %s you need to be a maintainer of it's %s area."), 
		...
		E19_PRODUCT_INTEGRATION_LIMIT_REACHED(19, "Integrations per product are limited to %d."), 
