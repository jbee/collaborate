...
public interface Change {
	...
	public static Change advance(Name output, IDN basis, Purpose purpose, Gist gist, Name reporter) {
		return (t, tx) -> { tx.put(advance, t.reportAdvancement(tx.task(output, basis), purpose, gist, tx.user(reporter))); };
	}
