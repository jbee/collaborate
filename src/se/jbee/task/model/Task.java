...
public final class Task extends Entity<Task> {
	 ...
	 * TODO this could also mean they want or could to provide a resource
	 */
	...
	/**
	 * Both {@link #aspirants} and {@link #supporterCount()} are supporters of this task.
	 * This field is used to avoid recomputing the union again and again.
	 */
	private transient Names supporters;
	/**
	...
	public int age(Date today) {
		return max(0, today.daysSince(reported)) + 1;
	}
	...
	public Names supporters() {
		if (supporters == null)
			supporters = participants.union(aspirants);
		return supporters;
	}
